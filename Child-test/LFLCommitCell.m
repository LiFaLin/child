...
#import "LFLCommitPhotoView.h"
#import "LFLCommit.h"
#import "LFLStartView.h"
#import "LFLImgLeftBtn.h"
#import "LFLButton.h"
@interface LFLCommitCell()
// 头像
...
// 图片视图
@property(nonatomic, weak) LFLCommitPhotoView    *photosView;
// 星级视图
@property(nonatomic, weak) LFLStartView          *starView;
// 模型
@property(nonatomic, strong) LFLCommit           *commit;

@end
@implementation LFLCommitCell
...
-(void)setCommitFrame:(LFLCommitFrame *)commitFrame{
    ...
    // 设置控件的数据
    LFLCommit *commit = commitFrame.commit;
...
-(void)likeBtnClick:(LFLImgLeftBtn *)sender{
...
-(void)disLikeBtnClick:(LFLImgLeftBtn *)sender{
...
//    [iconView zj_cornerRadiusRoundingRect];
    ...
    LFLStartView *starView = [[LFLStartView alloc]init];
    ...
    LFLImgLeftBtn *likeBtn = [[LFLImgLeftBtn alloc]init];
    ...
    LFLImgLeftBtn *disLikeBtn = [[LFLImgLeftBtn alloc]init];
    ...
    LFLCommitPhotoView *photosView = [[LFLCommitPhotoView alloc]init];
